...
@Entity
@Table(name="pnj_customer_nosale_details")
public class PNJCustomerNoSaleDetails implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5220614009781474542L;
	...
	public String toString() {
		return "id "+id+" Name "+customer_name;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof PNJCustomerNoSaleDetails))
			return false;
		PNJCustomerNoSaleDetails other = (PNJCustomerNoSaleDetails) obj;
		if (id == null) {
			if (other.id != null)
				return false;
